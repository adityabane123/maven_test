...
app.controller("mycontroller1",function($http,$scope){
	var dataObj = {
			"name" : "Java Honk",
			"location" : "NY",
			"phone" : "123456789"
	...
	var res = $http.get('${pageContext.request.contextPath}/result/angu_opr.do');
	res.success(function(data, status, headers, config) {
		$scope.employees = data;
		$scope.sortCol="user_name";
	});
...
<br>
<br>
Serch By Name : <input type="text" ng-model="searchtxt.user_name">
<br>
<br>
<table>
<thead>
